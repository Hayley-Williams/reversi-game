...
io.sockets.on('connection', function (socket) {
    ...
    */
    ...
    socket.on('join_room', function (payload) {
        ...
        /* Tell everyone that is already in teh room that someone just joined */
    ...
    */
    ...
    /* payload:
        ...
        {
            'result': 'sucess',
            'socket_id' : the socket id of the person doing the uninvite
        }
        or
        {
            'result': 'fail',
    ...
    */
    socket.on('play_token', function (payload) {
        ...
        /* Check that the player that has previously registered */
        ...
        /* he put an extra }); in the Play Token Part 1 video at 22:45 */
    });
});
...
function send_game_update(socket, game_id, message) {
    ...
    console.log('**DEBUG-#5 Game ID is ' + games[game_id]);
    ...
    if (games[game_id].player_white.socket == '') {
        if (games[game_id].player_black.socket != socket.id) {
            ...
            console.log('**DUBUG** Server.js checking player_white.socket' + games[game_id].player_white.socket);
        }
    }

    if (games[game_id].player_black.socket == '') {
        console.log('**DUBUG-#3** Server.js checking player_black.socket' + games[game_id].player_black.socket);
        console.log('white socket id :' + games[game_id].player_white.socket);
        ...
        if (games[game_id].player_white.socket != socket.id) {
            ...
            console.log('**DUBUG** Server.js checking player_black.socket' + games[game_id].player_black.socket);
        }
    }
